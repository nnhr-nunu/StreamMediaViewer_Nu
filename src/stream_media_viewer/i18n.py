...
STRINGS = {
    "ja": {
        ...
        "place_yes": "位置情報あり",
        "rect": "四角でぼかす",
        "brush": "筆でぼかす。太さはこのモードのとき出ます",
        "manual": "手動ぼかし。ONのとき筆と四角が出ます。筆が初期です",
    ...
    "en": {
        ...
        "brush": "Brush blur. Thickness appears in this mode",
        "manual": "Manual blur. Brush and box appear when this is on. Brush is the default",
